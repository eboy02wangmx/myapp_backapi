...
public class ConstantsEnum {
    ...
    public static enum API_ID {
        MG1_O_0001("MG1_O_0001", "申込一覧取得"),
        MG1_O_0002("MG1_O_0002", "契約照会"),
        MG1_O_0003("MG1_O_0003", "計上取消"),
        MG1_O_0004("MG1_O_0004", "点検一覧取得"),
        MG1_O_0005("MG1_O_0005", "点検情報取得"),
        MG1_O_0006("MG1_O_0006", "点検完了処理"),
        MG1_O_0008("MG1_O_0008", "訂正時更新処理"),
        MG1_O_0009("MG1_O_0009", "再アップ依頼処理"),
        MG1_O_0010("MG1_O_0010", "一時保存検索"),
        MG1_O_0011("MG1_O_0011", "一時保存照会"),
        MG1_O_0019("MG1_O_0019", "点検画像取得（拡大表示）"),
        MG1_O_0020("MG1_O_0020", "営業課店検索"),
        MG1_O_0021("MG1_O_0021", "代理店検索"),
        MG1_O_0023("MG1_O_0023", "申込CSV作成"),
        MG1_O_0024("MG1_O_0024", "点検CSV作成"),
        MG1_O_0025("MG1_O_0025", "一時保存CSV作成"),
        MG1_O_0029("MG1_O_0029", "申込一時保存情報更新"),
        MG1_O_0050("MG1_O_0050", "変更依頼受付検索"),
        MG1_O_0051("MG1_O_0051", "変更依頼CSV作成"),
        MG1_O_0110("MG1_O_0110", "明記物件明細帳票作成"),
        MG1_O_0111("MG1_O_0111", "送り状帳票作成"),
        MG1_O_0153("MG1_O_0153", "所属内務課コード検索"),
        NHA_O_0001("NHA_O_0001", "申込一時保存読込"),
        ...
        MKY_O_0001("MKY_O_0001", "申込一時保存一覧取得"),
        MKY_O_0002("MKY_O_0002", "申込一時保存削除"),
        MKY_O_0003("MKY_O_0003", "契約一覧取得"),
        MKY_O_0004("MKY_O_0004", "契約内容詳細取得"),
        MKY_O_0005("MKY_O_0005", "契約内容確認書作成_HA"),
        MKY_O_0006("MKY_O_0006", "変更依頼内容確認_HA"),
        MKY_O_0007("MKY_O_0007", "変更依頼受付登録_HA"),
        MKY_O_0009("MKY_O_0009", "クレジットカード情報変更登録"),
        MKY_O_0020("MKY_O_0020", "前回ログイン日付取得"),
        MKY_O_0040("MKY_O_0040", "メールアドレス確認"),
        MKY_O_0041("MKY_O_0041", "メールアドレス変更登録"),
        MKY_O_0042("MKY_O_0042", "メールアドレス変更準備"),
        MKY_O_0043("MKY_O_0043", "メールアドレス変更確定"),
        MKY_O_0044("MKY_O_0044", "メールアドレス変更取得"),
        MKY_O_0060("MKY_O_0060", "MyPageログインチェック"),
        MKY_O_0061("MKY_O_0061", "MyPageログイン"),
        MKY_O_0062("MKY_O_0062", "楽天ID認証"),
        MKY_O_0063("MKY_O_0063", "楽天会員情報取得"),
        MKY_O_0064("MKY_O_0064", "ログアウト"),
        MG1_O_0052("MG1_O_0052", "変更依頼未確認件数取得"),
        MG1_O_0053("MG1_O_0053", "変更依頼確認済フラグ更新"),
        MG1_O_0027("MG1_O_0027", "代理店存在チェック"),
        //契約登録情報追加  2018/11/13  ADD  START
        MG1_O_0090("MG1_O_0090", "契約登録情報"),
        MG1_O_0091("MG1_O_0091", "契約登録情チェック"),
        MG1_O_0092("MG1_O_0092", "契約登録情報完了"),
        MG1_O_0114("MG1_O_0114", "訂正連絡処理"),
        //契約登録情報追加  2018/11/13  ADD  END
        MG1_O_0115("MG1_O_0115", "訂正回答処理"),
        //訂正項目選択追加  2019/02/22  ADD  START
        MG1_O_0113("MG1_O_0113", "訂正項目選択処理"),
        //訂正項目選択追加  2019/02/22  ADD  END
        MG1_O_0116("MG1_O_0116", "点検完了処理"),
        //管理メンテナンス情報登録または更新 2018/11/26 ADD START
        MG1_O_0151("MG1_O_0151", "管理メンテナンス情報一覧取得"),
        MG1_O_0152("MG1_O_0152", "管理メンテナンス情報登録更新"),
        //管理メンテナンス情報登録または更新 2018/11/26/ ADD END
    	//訂正件数取得追加  2019/03/26  ADD  START
        MG1_O_0103("MG1_O_0113", "訂正件数取得");
        //訂正件数取得追加  2019/03/26  ADD  END
        private String id;
        private String name;
