...
import jp.co.myapp.api.domain.validate.handle.CustomizeTypeSizeIntegerValidator;
...
@Constraint(validatedBy = { CustomizeTypeSizeLongValidator.class, CustomizeTypeSizeIntegerValidator.class, CustomizeTypeSizeStringValidator.class })
public @interface CustomizeTypeSizeInteger {
