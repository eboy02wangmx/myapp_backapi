...
public class CustomizeTypeSizeLongValidator implements ConstraintValidator<CustomizeTypeSizeLong, Long> {

	private CustomizeTypeSizeLong cts;

	@Override
	public void initialize(CustomizeTypeSizeLong annotation) {
		this.cts = annotation;
	}
