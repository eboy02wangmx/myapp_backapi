...
<script language="JavaScript" type="text/javascript" src="/static/js/kr/work_add.js?v=0415"></script>
                ...
                var video = {};
                  ...
                  info =  info.response;
                   video.location = eval("("+info+")").key;
                   	...
                   	var tempresponse = info.response;
                    video.location = eval("("+tempresponse+")").key;
                  }
              // console.log(info);
