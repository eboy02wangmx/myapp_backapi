...
(function (w, d, undefined) {
    ...
    if (_U.isDev) {
        ...
        _U.loadCss('/myapp-backend/static/css/zui.min.css');
        _U.loadCss('/myapp-backend/template/default/css/zui-theme.css');
        _U.loadCss('/myapp-backend/template/default/css/fileinput.min.css');
        _U.loadCss('/myapp-backend/template/default/css/bootstrap-switch.css');
        _U.loadCss('/myapp-backend/template/default/css/chosen.min.css');
        _U.loadCss('/myapp-backend/template/default/css/zui.datatable.min.css');
        //_U.loadCss'../plugin/loading/msgbox.css');
       // _U.loadCss('/static/css/kr/common.css');
        _U.loadCss('/myapp-backend/template/default/css/response.css');


        _U.loadJs('/myapp-backend/static/js/jquery-1.9.1.js');
        _U.loadJs('/myapp-backend/static/js/zui.js?v=3.0');
        _U.loadJs('/myapp-backend/static/js/bootstrap-switch.min.js');
        _U.loadJs('/myapp-backend/static/js/chosen.js');
        _U.loadJs('/myapp-backend/static/js/zui.datatable.min.js');
		_U.loadJs('/myapp-backend/static/js/zui.sortable.min.js');
        _U.loadJs('/myapp-backend/static/js/bootbox.js');
        _U.loadJs('/myapp-backend/static/js/fileinput-v4.34.js');
        _U.loadJs('/myapp-backend/static/js/fileinput_locale_zh.js');
         _U.loadJs('/myapp-backend/static/js/common.js');
        //_U.loadJs('../plugin/loading/msgbox.js');
        //_U.loadJs('../plugin/jqPaginator/jqPaginator.min.js');

        _U.loadJs('/myapp-backend/static/js/submit.js');
        _U.loadJs('/myapp-backend/static/js/biz.js');
        _U.loadJs('/myapp-backend/static/kindeditor/kindeditor-min.js');
