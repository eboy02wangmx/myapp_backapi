...
(function (w, d, undefined) {
    ...
    if (_U.isDev) {
        ...
        _U.loadCss('/myapp-backend/static/css/zui-theme.css');
        _U.loadCss('/myapp-backend/static/css/fileinput.min.css');
        _U.loadCss('/myapp-backend/static/css/bootstrap-switch.css');
        _U.loadCss('/myapp-backend/static/css/chosen.min.css');
        _U.loadCss('/myapp-backend/static/css/zui.datatable.min.css');
        //_U.loadCss'../plugin/loading/msgbox.css');
       // _U.loadCss('/static/css/kr/common.css');
        _U.loadCss('/myapp-backend/static/css/response.css');
